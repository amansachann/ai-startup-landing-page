    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className="absolute h-[544px] w-[544px] md:w-[980px] md:h-[980px] border border-white rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed opacity-20"
        >
